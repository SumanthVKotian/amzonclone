...
public class AddressService implements AddressServiceInterface {
	...
	public AddressCrudRepo getAddressCrudRepo() {
		return addressCrudRepo;
	}


	public void setAddressCrudRepo(AddressCrudRepo addressCrudRepo) {
		this.addressCrudRepo = addressCrudRepo;
	}
