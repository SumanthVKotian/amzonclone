...
public class LoginService implements LoginServiceInterface {
	...
	public SellerServiceInterface getSellerService() {
		return sellerService;
	}


	public void setSellerService(SellerServiceInterface sellerService) {
		this.sellerService = sellerService;
	}


	public LoginCrudRepo getLoginRepo() {
		return loginRepo;
	}


	public void setLoginRepo(LoginCrudRepo loginRepo) {
