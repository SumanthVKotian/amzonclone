...
public class SellerService implements SellerServiceInterface {
	...
	public SellerCrudRepo getSellerCrudRepo() {
		return sellerCrudRepo;
	}


	public void setSellerCrudRepo(SellerCrudRepo sellerCrudRepo) {
		this.sellerCrudRepo = sellerCrudRepo;
	}
