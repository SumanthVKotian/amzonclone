...
public class CartService implements CartServiceInterface {
	...
	public CartCrudRepo getCartCrudRepo() {
		return cartCrudRepo;
	}


	public void setCartCrudRepo(CartCrudRepo cartCrudRepo) {
		this.cartCrudRepo = cartCrudRepo;
	}


	public CustomerCrudRepo getCustomerCrudRepo() {
		return customerCrudRepo;
	}


	public void setCustomerCrudRepo(CustomerCrudRepo customerCrudRepo) {
		this.customerCrudRepo = customerCrudRepo;
	}


	public ItemCrudRepo getItemCrudRepo() {
		return itemCrudRepo;
	}


	public void setItemCrudRepo(ItemCrudRepo itemCrudRepo) {
		this.itemCrudRepo = itemCrudRepo;
	}
